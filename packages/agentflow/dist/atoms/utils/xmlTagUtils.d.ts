 ...
 */
export declare function isHtmlContent(content: unknown): boolean
/**
 ...
 */
export declare function getEditorMarkdown(editor: { getMarkdown(): string; getHTML(): string; isEmpty: boolean }): string
/**
 ...
 */
export declare function unescapeXmlEntities(json: PmNode): PmNode
/**
 ...
 */
export declare function unescapeXmlTags(text: string): string
/**
 ...
 */
export declare function restoreTextMentions(node: JsonNode, hasMentions: boolean): JsonNode[]
export {}
