...
import { ExecutionStatus, FlowExecutionState } from './execution'
import { FlowConfig, FlowEdge, FlowNode } from './flow'
import { InputParam, NodeData, NodeDataSchema } from './node'
...
export type AgentflowAction =
    ...
    | {
          ...
          payload: ReactFlowInstance | null
      }
    | {
