...
exports.getDatabaseSSLFromEnv = exports.init = void 0;
...
const init = async () => {
    let homePath;
    let flowisePath = path_1.default.join((0, utils_1.getUserHome)(), '.accelance');
    ...
    switch (process.env.DATABASE_TYPE) {
        ...
        case 'mysql':
            appDataSource = new typeorm_1.DataSource({
                ...
                ssl: (0, exports.getDatabaseSSLFromEnv)()
            });
            break;
        case 'mariadb':
            appDataSource = new typeorm_1.DataSource({
        ...
        case 'postgres':
            appDataSource = new typeorm_1.DataSource({
                ...
                poolErrorHandler: (err) => {
                    logger_1.default.error(`Database pool error: ${JSON.stringify(err)}`);
                },
                applicationName: 'Accelance'
            });
            break;
        default:
            homePath = process.env.DATABASE_PATH ?? flowisePath;
...
exports.getDatabaseSSLFromEnv = getDatabaseSSLFromEnv;
