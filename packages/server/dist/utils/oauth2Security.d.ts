 ...
 */
export declare function getOAuth2AllowedDomains(): string[];
/**
 ...
 */
export declare function validateOAuth2Url(url: string): void;
/**
 ...
 */
export declare function extractOAuth2TokenFields(data: Record<string, any>): Record<string, any>;
