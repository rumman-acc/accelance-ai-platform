...
const getSingleFlowConfig = async (chatflowId, workspaceId) => {
    try {
        ...
        throw new internalAccelanceError_1.InternalAccelanceError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: flowConfigService.getSingleFlowConfig - ${(0, utils_2.getErrorMessage)(error)}`);
    }
};
exports.default = {
    getSingleFlowConfig
