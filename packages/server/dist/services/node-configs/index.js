...
const getAllNodeConfigs = async (requestBody) => {
    try {
        ...
        throw new internalAccelanceError_1.InternalAccelanceError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: nodeConfigsService.getAllNodeConfigs - ${(0, utils_2.getErrorMessage)(error)}`);
    }
};
exports.default = {
    getAllNodeConfigs
