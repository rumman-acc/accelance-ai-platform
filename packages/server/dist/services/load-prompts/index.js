...
const createPrompt = async (promptName) => {
    try {
        ...
        throw new internalAccelanceError_1.InternalAccelanceError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: loadPromptsService.createPrompt - ${(0, utils_1.getErrorMessage)(error)}`);
    }
};
exports.default = {
    createPrompt
