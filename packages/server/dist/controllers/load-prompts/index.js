...
const createPrompt = async (req, res, next) => {
    try {
        if (typeof req.body === 'undefined' || !req.body.promptName) {
            throw new internalAccelanceError_1.InternalAccelanceError(http_status_codes_1.StatusCodes.PRECONDITION_FAILED, `Error: loadPromptsController.createPrompt - promptName not provided!`);
        }
