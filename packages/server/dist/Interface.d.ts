import { IAction, ICommonObject, IFileUpload, IHumanInput, INode, INodeData as INodeDataFromComponent, INodeExecutionData, INodeParams, IServerSideEventStreamer } from 'accelance-components';
...
export declare enum CustomMcpServerStatus {
    PENDING = "PENDING",
    AUTHORIZED = "AUTHORIZED",
    ERROR = "ERROR"
}
export declare enum CustomMcpServerAuthType {
    NONE = "NONE",
    CUSTOM_HEADERS = "CUSTOM_HEADERS"
}
export declare enum CustomMcpServerTransportType {
    URL = "url",
    STDIO = "stdio"
}
