...
class AddCustomMcpServerStdioTransport1790000000000 {
    async up(queryRunner) {
        await queryRunner.query(`CREATE TABLE "temp_custom_mcp_server" ("id" varchar PRIMARY KEY NOT NULL, "name" varchar NOT NULL, "serverUrl" text, "iconSrc" varchar, "color" varchar, "authType" varchar NOT NULL DEFAULT ('NONE'), "authConfig" text, "tools" text, "toolCount" integer NOT NULL DEFAULT (0), "status" varchar NOT NULL DEFAULT ('PENDING'), "createdDate" datetime NOT NULL DEFAULT (datetime('now')), "updatedDate" datetime NOT NULL DEFAULT (datetime('now')), "workspaceId" text NOT NULL, "transportType" varchar NOT NULL DEFAULT ('url'), "command" varchar, "args" text, "env" text);`);
        await queryRunner.query(`INSERT INTO "temp_custom_mcp_server" ("id", "name", "serverUrl", "iconSrc", "color", "authType", "authConfig", "tools", "toolCount", "status", "createdDate", "updatedDate", "workspaceId") SELECT "id", "name", "serverUrl", "iconSrc", "color", "authType", "authConfig", "tools", "toolCount", "status", "createdDate", "updatedDate", "workspaceId" FROM "custom_mcp_server";`);
