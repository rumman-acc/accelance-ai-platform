...
exports.AddGuardrailCatalogItemBatch2_1785000000001 = void 0;
class AddGuardrailCatalogItemBatch2_1785000000001 {
    async up(queryRunner) {
        await queryRunner.query(`INSERT IGNORE INTO \`guardrail_catalog_item\` (\`id\`,\`key\`,\`name\`,\`description\`,\`kind\`,\`category\`,\`nodeNames\`,\`enforcementStatus\`,\`configSchema\`,\`defaultConfig\`,\`isStandard\`)
             VALUES
    ...
    async down(queryRunner) {
        await queryRunner.query(`DELETE FROM \`guardrail_catalog_item\` WHERE \`key\` IN ('spend_token_budgets','hitl_approval_gates','loop_recursion_detection','egress_filtering','confused_deputy_prevention','memory_rag_write_validation');`);
    }
}
exports.AddGuardrailCatalogItemBatch2_1785000000001 = AddGuardrailCatalogItemBatch2_1785000000001;
//# sourceMappingURL=1785000000001-AddGuardrailCatalogItemBatch2.js.map