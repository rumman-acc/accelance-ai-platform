...
/**
 * See the postgres sibling migration (1794000000000-SeedGuardrailDefinitions.ts) for the full
 * rationale comment -- kept identical here to avoid drift across driver files.
 */
export class SeedGuardrailDefinitions1794000000001 implements MigrationInterface {
