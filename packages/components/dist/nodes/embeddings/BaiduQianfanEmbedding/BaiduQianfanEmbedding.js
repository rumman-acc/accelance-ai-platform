...
class BaiduQianfanEmbedding_Embeddings {
    constructor() {
        ...
        this.inputs = [
            ...
            },
            {
                ...
                warning: 'Qianfan has stricter limits on individual text length. If you encounter a length error, reduce chunk size to 500 and set Batch Size to 1.'
            },
            {
                label: 'Timeout',
                name: 'timeout',
    ...
    async init(nodeData, _, options) {
        ...
        if (typeof stripNewLines === 'boolean')
