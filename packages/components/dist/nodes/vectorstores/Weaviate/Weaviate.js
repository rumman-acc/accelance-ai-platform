    ...
    constructor() {
        ...
        this.vectorStoreMethods = {
            async upsert(nodeData, options) {
                ...
                const client = await createWeaviateClient(weaviateConnectionType, weaviateHost, weaviateHttpSecure, weaviateGrpcHost, weaviateGrpcSecure, weaviateApiKey);
        ...
        this.inputs.push({
            ...
            name: 'alpha',
            description: 'Number between 0 and 1 that determines the weighting of keyword (BM25) portion of the hybrid search. A value of 1 is a pure vector search, while 0 is a pure keyword search.',
            placeholder: '1',
            type: 'number',
            additionalParams: true,
            optional: true
