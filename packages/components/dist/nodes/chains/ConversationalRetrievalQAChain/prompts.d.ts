export declare const CUSTOM_QUESTION_GENERATOR_CHAIN_PROMPT =
...
export declare const RESPONSE_TEMPLATE =
...
export declare const QA_TEMPLATE =
    'Use the following pieces of context to answer the question at the end.\n\n{context}\n\nQuestion: {question}\nHelpful Answer:'
export declare const REPHRASE_TEMPLATE =
