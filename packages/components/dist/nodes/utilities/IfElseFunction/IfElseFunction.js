...
class IfElseFunction_Utilities {
    ...
    async init(nodeData, input, options) {
        ...
        try {
            ...
            if (responseTrue)
                return {
                    output: typeof responseTrue === 'string' ? (0, utils_1.handleEscapeCharacters)(responseTrue, false) : responseTrue,
                    type: true
                }
            const responseFalse = await (0, utils_1.executeJavaScriptCode)(elseFunction, sandbox)
            return {
                output: typeof responseFalse === 'string' ? (0, utils_1.handleEscapeCharacters)(responseFalse, false) : responseFalse,
                type: false
            }
        } catch (e) {
            throw new Error(e)
