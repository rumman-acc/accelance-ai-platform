                    ...
                    ? // @ts-ignore
                      new pdf_1.PDFLoader(blob, {
                          ...
                          pdfjs: () =>
                              // @ts-ignore
                              legacyBuild
                                  ? Promise.resolve().then(() => __importStar(require('pdfjs-dist/legacy/build/pdf.js')))
                                  : Promise.resolve().then(() => __importStar(require('pdf-parse/lib/pdf.js/v1.10.100/build/pdf.js')))
                      })
                    : // @ts-ignore
                      new pdf_1.PDFLoader(blob, {
                          pdfjs: () =>
