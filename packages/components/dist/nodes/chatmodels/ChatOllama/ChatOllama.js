...
const FlowiseChatOllama_1 = require("./FlowiseChatOllama");
class ChatOllama_ChatModels {
    constructor() {
        ...
        this.baseClasses = [this.type, ...(0, utils_1.getBaseClasses)(FlowiseChatOllama_1.ChatOllama)];
        this.credential = {
    ...
    async init(nodeData, _, options) {
        ...
        const keepAlive = nodeData.inputs?.keepAlive;
        ...
        const jsonMode = nodeData.inputs?.jsonMode;
        const streaming = nodeData.inputs?.streaming;
        const think = nodeData.inputs?.think;
        ...
        const ollamaApiKey = (0, utils_1.getCredentialParam)('ollamaApiKey', credentialData, nodeData);
        if (ollamaApiKey) {
            obj.headers = new Headers({
                Authorization: `Bearer ${ollamaApiKey}`
            });
        }
        const model = new FlowiseChatOllama_1.ChatOllama(nodeData.id, obj);
