...
export declare const processImageMessage: (
    llm: BaseChatModel,
    nodeData: INodeData,
 ...
 */
export declare function filterConversationHistory(
    historySelection: ConversationHistorySelection,
    input: string,
    state: ISeqAgentsState
): BaseMessage[]
export declare const restructureMessages: (
    llm: BaseChatModel,
    state: ISeqAgentsState
) => BaseMessage<
    import('@langchain/core/messages').MessageStructure<import('@langchain/core/messages').MessageToolSet>,
    import('@langchain/core/messages').MessageType
>[]
...
export declare const checkMessageHistory: (
    nodeData: INodeData,
    options: ICommonObject,
