...
exports.findBestScenarioIndex = void 0;
const findBestScenarioIndex = (scenarios, calledOutputName) => {
    ...
    if (matchedScenarioIndex === -1) {
        matchedScenarioIndex = scenarios.findIndex((scenario) => scenario.scenario.toLowerCase().includes(normalizedOutput) || normalizedOutput.includes(scenario.scenario.toLowerCase()));
    }
...
exports.findBestScenarioIndex = findBestScenarioIndex;
//# sourceMappingURL=matchScenario.js.map