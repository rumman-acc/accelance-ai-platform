...
class ListRequestsTool extends BaseJiraServiceManagementTool {
    ...
    async _call(arg) {
        ...
        if (params.serviceDeskId)
            queryParams.append('serviceDeskId', params.serviceDeskId);
...
const createJiraServiceManagementTools = (args) => {
    ...
    if (actions.includes('list_service_desks')) {
        tools.push(new ListServiceDesksTool({
            username,
            accessToken,
            siteUrl,
            maxOutputLength,
    ...
    if (actions.includes('create_customer_request')) {
        tools.push(new CreateCustomerRequestTool({
            username,
            accessToken,
            siteUrl,
            maxOutputLength,
    ...
    if (actions.includes('list_requests')) {
        tools.push(new ListRequestsTool({
            username,
            accessToken,
            siteUrl,
            maxOutputLength,
