...
exports.validateMCPServerConfig = exports.validateCommandFlags = exports.validateEnvironmentVariables = exports.validateCommandInjection = exports.validateArgsForLocalFileAccess = exports.MCPToolkit = void 0;
...
const validateEnvironmentVariables = (env) => {
    const allowedEnvVars = new Set((process.env.CUSTOM_MCP_ALLOWED_ENV_VARS ?? '')
        .split(',')
        .map((s) => s.trim())
        .filter(Boolean));
