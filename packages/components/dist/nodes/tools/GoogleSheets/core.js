...
const CreateSpreadsheetSchema = v3_1.z.object({
    title: v3_1.z.string().describe('The title of the spreadsheet'),
...
const GetValuesSchema = v3_1.z.object({
    ...
    range: v3_1.z.string().describe('The A1 notation of the range to retrieve values from'),
    valueRenderOption: v3_1.z
        .enum(['FORMATTED_VALUE', 'UNFORMATTED_VALUE', 'FORMULA'])
        .optional()
        .default('FORMATTED_VALUE')
        .describe('How values should be represented'),
    dateTimeRenderOption: v3_1.z
