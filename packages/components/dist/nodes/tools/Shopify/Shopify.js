        ...
        this.inputs = [
            {
                ...
                type: 'string',
                default: '2025-01',
                description: 'Shopify Admin API version to use (e.g. 2025-01). Shopify sunsets API versions roughly a year after release, so this may need to be bumped periodically.'
            },
            {
                label: 'Actions',
                name: 'actions',
