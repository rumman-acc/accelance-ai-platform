...
const CreateDocumentSchema = v3_1.z.object({
    title: v3_1.z.string().describe('Document title'),
    text: v3_1.z.string().optional().describe('Text content to insert after creating document'),
    index: v3_1.z.number().optional().default(1).describe('Index where to insert text or media (1-based, default: 1 for beginning)'),
...
const UpdateDocumentSchema = v3_1.z.object({
    ...
    index: v3_1.z.number().optional().default(1).describe('Index where to insert text or media (1-based, default: 1 for beginning)'),
    replaceText: v3_1.z.string().optional().describe('Text to replace'),
    newText: v3_1.z.string().optional().describe('New text to replace with'),
