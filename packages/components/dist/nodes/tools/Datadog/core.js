...
const createDatadogTools = (args) => {
    ...
    if (actions.includes('list_monitors')) {
        tools.push(new ListMonitorsTool({
            apiKey,
            appKey,
            site,
            maxOutputLength,
    ...
    if (actions.includes('create_monitor')) {
        tools.push(new CreateMonitorTool({
            apiKey,
            appKey,
            site,
            maxOutputLength,
    ...
    if (actions.includes('query_metrics')) {
        tools.push(new QueryMetricsTool({
            apiKey,
            appKey,
            site,
            maxOutputLength,
