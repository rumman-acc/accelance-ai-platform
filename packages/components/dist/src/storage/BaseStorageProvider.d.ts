...
export declare abstract class BaseStorageProvider implements IStorageProvider {
    ...
    abstract addArrayFilesToStorage(mime: string, bf: Buffer, fileName: string, fileNames: string[], ...paths: string[]): Promise<StorageResult>;
    ...
    abstract streamStorageFile(chatflowId: string, chatId: string, fileName: string, orgId: string): Promise<fs.ReadStream | Buffer | undefined>;
