 ...
 */
export declare function secureAxiosRequest(config: AxiosRequestConfig, maxRedirects?: number, agentOptions?: SecureRequestAgentOptions): Promise<AxiosResponse>;
/**
 ...
 * @throws Error if any URL in the redirect chain is denied
 */
export declare function secureFetch(url: string, init?: RequestInit, maxRedirects?: number, agentOptions?: SecureRequestAgentOptions): Promise<Response>;
