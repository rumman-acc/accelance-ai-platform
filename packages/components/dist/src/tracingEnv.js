...
exports.applyEnvTracingProviders =
    exports.tracingEnvEnabled =
    exports.TRACING_ENV_PROVIDERS =
    exports.getLangSmithEnvConfig =
    exports.resetTracingEnvCache =
        void 0
...
const getLangSmithEnvConfig = () => {
    const tracingFlag =
        (0, utils_1.getEnvironmentVariable)('LANGSMITH_TRACING') ?? (0, utils_1.getEnvironmentVariable)('LANGCHAIN_TRACING_V2')
