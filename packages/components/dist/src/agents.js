...
exports.JsonOutputToolsParser =
    exports.ToolCallingAgentOutputParser =
    exports.XMLAgentOutputParser =
    exports.createReactAgent =
    exports.formatAgentSteps =
    exports.AgentExecutor =
    exports.AgentExecutorIterator =
...
class AgentExecutorIterator extends serializable_1.Serializable {
    ...
    async onFirstStep() {
        if (this.iterations === 0) {
            const callbackManager = await manager_1.CallbackManager.configure(
                this.callbacks,
...
class AgentExecutor extends chains_1.BaseChain {
    ...
    async _call(inputs, runManager, config) {
        ...
        const getOutput = async (finishStep) => {
            ...
            if (artifacts.length) additional.artifacts = (0, lodash_1.flatten)(artifacts)
    ...
    if (message.tool_calls !== undefined && message.tool_calls.length > 0) {
        ...
        for (const toolCall of message.additional_kwargs.tool_calls ?? []) {
            ...
            try {
                ...
                throw new output_parsers_1.OutputParserException(
