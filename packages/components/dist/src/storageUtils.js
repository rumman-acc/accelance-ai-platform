...
exports.getStorageSize = exports.streamStorageFile = exports.removeFolderFromStorage = exports.removeSpecificFileFromStorage = exports.removeSpecificFileFromUpload = exports.removeFilesFromStorage = exports.getStorageType = exports.getModelsCachePath = exports.getStoragePath = exports.getFilesListFromStorage = exports.getFileFromStorage = exports.getFileFromUpload = exports.addSingleFileToStorage = exports.addArrayFilesToStorage = exports.addBase64FilesToStorage = void 0;
...
const getModelsCachePath = () => {
    const cacheDir = process.env.MODEL_CACHE_DIR ? path_1.default.join(process.env.MODEL_CACHE_DIR) : path_1.default.join((0, utils_1.getUserHome)(), '.flowise');
