...
import { CreateReactAgentParams, AgentExecutorInput, AgentActionOutputParser, BaseSingleActionAgent, BaseMultiActionAgent, StoppingMethod } from '@langchain/classic/agents';
...
export declare const createReactAgent: ({ llm, tools, prompt }: CreateReactAgentParams) => Promise<RunnableSequence<{
    steps: AgentStep[];
}, AgentAction | import("@langchain/core/agents").AgentFinish>>;
