...
class Browserbase_MCP implements INode {
    label: string
    name: string
    version: number
    description: string
    ...
    async getTools(nodeData: INodeData, options: ICommonObject): Promise<Tool[]> {
        ...
        const apiKey = getCredentialParam('browserbaseApiKey', credentialData, nodeData)
        const projectId = getCredentialParam('browserbaseProjectId', credentialData, nodeData)
