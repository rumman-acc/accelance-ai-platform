...
const PLATFORM_PILLARS = [
    {
        ...
        body: 'A branching Agent Swarm with loops and human-input checkpoints, a supervisor/worker multi-agent pattern, and an explicit state-machine sequential system — plus single-agent modes and 11 classic chain types. Or describe the process in plain language and generate the agent swarm.'
    },
    {
        icon: 'Cpu',
